...
static void config_button_pressed_handler(GtkButton * button, gpointer user_data) {
...
static void client_app_window_init(ClientAppWindow * win) {
    ...
    g_signal_connect(win->config, "clicked", G_CALLBACK(config_button_pressed_handler), win);
